...
function CardPreview({
  cardNumber,
  cardValidityPeriod,
  CARD_COMPANY_COLORS: CARD_COMPANY_COLORS2
}) {
  ...
  return /* @__PURE__ */ jsxs(Card, { CARD_COMPANY_COLORS: CARD_COMPANY_COLORS2, children: [
    /* @__PURE__ */ jsx$1(IcChip, {}),
    /* @__PURE__ */ jsxs(CardInfoWrapper, { CARD_COMPANY_COLORS: CARD_COMPANY_COLORS2, children: [
      /* @__PURE__ */ jsx$1(CardNumberWrapper, { children: cardNumber.map((number, index) => {
        if (index < CARD_PREVIEW_RULE.SENSITIVE_INFO) {
          return /* @__PURE__ */ jsx$1(CardNumber, { children: number }, index);
        }
        return /* @__PURE__ */ jsx$1(CardNumber, { children: "⦁".repeat(number.length) }, index);
      }) }),
      /* @__PURE__ */ jsxs("div", { children: [
        month !== "" ? /* @__PURE__ */ jsxs("span", { children: [
          month,
          "/"
        ] }) : null,
        /* @__PURE__ */ jsx$1("span", { children: year })
      ] })
    ] }),
    imgPath && /* @__PURE__ */ jsx$1(CardLogo, { src: imgPath })
  ] });
}
const Card = newStyled.div`
  ...
  height: 152px;
  border-radius: 4px;
  background: ${({ CARD_COMPANY_COLORS: CARD_COMPANY_COLORS2 }) => CARD_COMPANY_COLORS2};
...
const CardInfoWrapper = newStyled.div`
  ...
  font-size: 14px;
  font-weight: 500;
  color: ${({ CARD_COMPANY_COLORS: CARD_COMPANY_COLORS2 }) => CARD_COMPANY_COLORS2 === "#FFE600" ? "#000000" : " #ffffff"};
  letter-spacing: 2px;
`;
...
function Button(props) {
  return /* @__PURE__ */ jsx$1("button", { ...props, children: props.text });
}
function CardInfoForm({
  ...
  const completedSteps = new Set(
    Object.entries(step).map(([componentName, isCompleted]) => {
      if (isCompleted) {
  ...
  const filteredChildren = children.filter((child) => completedSteps.has(child.props.name)).reverse();
  ...
  return /* @__PURE__ */ jsxs(CardForm, { onSubmit: handleAddCardFormSubmit, children: [
    filteredChildren,
    canSubmit && /* @__PURE__ */ jsx$1(CardFormButtonWrapper, { children: /* @__PURE__ */ jsx$1(Button, { css: cardFormButtonStyle, text: "확인", type: "submit" }) })
  ] });
}
const CardForm = newStyled.form`
  ...
  margin-top: 45px;
`;
const CardFormButtonWrapper = newStyled.div`
  position: fixed;
  bottom: 0;
  left: 50%;
...
function CardInputSection({
  ...
  return /* @__PURE__ */ jsxs(Wrapper$2, { $name: name, children: [
    /* @__PURE__ */ jsx$1(Title$1, { children: title }),
    description && /* @__PURE__ */ jsx$1(Description, { children: description }),
    children,
    errorMessage && /* @__PURE__ */ jsx$1(ErrorMessage, { children: errorMessage })
  ] });
}
const Wrapper$2 = newStyled.section`
  width: 100%;
...
function Input(props) {
  return /* @__PURE__ */ jsx$1(InputWrapper$4, { ...props });
}
...
function CardNumberField({
  ...
  return /* @__PURE__ */ jsxs("div", { children: [
    /* @__PURE__ */ jsx$1(Label$3, { htmlFor: "cardNumber-0", id: "cardNumber", children: "카드 번호" }),
    /* @__PURE__ */ jsx$1(InputWrapper$3, { children: cardNumber.map((v, index) => /* @__PURE__ */ jsx$1(
      Input,
      {
...
function CardValidityPeriodField({
  ...
  return /* @__PURE__ */ jsxs("div", { children: [
    /* @__PURE__ */ jsx$1(Label$2, { htmlFor: "cardValidityPeriod-month", id: "cardValidityPeriod", children: "유효기간" }),
    /* @__PURE__ */ jsxs(InputWrapper$2, { children: [
      /* @__PURE__ */ jsx$1(
        Input,
        {
...
const Label$2 = newStyled.label`
  font-size: 12px;
`;
function CardCVCField({ hasError, cardCVC, onChange }) {
  return /* @__PURE__ */ jsxs("div", { children: [
    /* @__PURE__ */ jsx$1(Label$1, { htmlFor: "CardCVC", children: "CVC" }),
    /* @__PURE__ */ jsx$1(InputWrapper$1, { children: /* @__PURE__ */ jsx$1(
      Input,
      {
        hasError,
        type: "tel",
...
const Label$1 = newStyled.label`
  font-size: 12px;
`;
function DropdownIcon({ toggleOpen }) {
  return /* @__PURE__ */ jsx$1(DropdownIconWrapper, { toggleOpen, children: /* @__PURE__ */ jsx$1(
    "svg",
    {
      width: "10",
      height: "6",
...
const DropdownIconWrapper = newStyled.div`
  position: absolute;
  top: 50%;
  right: 2%;
...
function Dropdown({
  ...
  const [toggleOpen, setToggleOpen] = reactExports.useState(false);
  const toggleDropdownState = () => {
    setToggleOpen((prev2) => !prev2);
  };
  const onClickDropdown = () => {
    toggleDropdownState();
  };
  const onEnterDropdown = (e) => {
    const { key } = e;
    if (key === "Enter") {
      toggleDropdownState();
      return true;
    ...
    /* @__PURE__ */ jsxs(
      Select,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx$1(DropdownIcon, { toggleOpen })
        ]
      }
    ),
    toggleOpen && /* @__PURE__ */ jsx$1(UnorderedList, { children: items.map((item) => /* @__PURE__ */ jsx$1(
      Item,
      {
...
function CardCompanyField({
  selectedCard,
  CARD_COMPANY_NAMES: CARD_COMPANY_NAMES2,
  CARD_COMPANY_PLACEHOLDER: CARD_COMPANY_PLACEHOLDER2,
  onClickCardCompany
}) {
  return /* @__PURE__ */ jsx$1(
    Dropdown,
    {
      placeholder: CARD_COMPANY_PLACEHOLDER2,
      items: [...CARD_COMPANY_NAMES2],
...
function CardPasswordField({
  ...
  return /* @__PURE__ */ jsxs("div", { children: [
    /* @__PURE__ */ jsx$1(Label, { htmlFor: "CardPassword", children: "비밀번호 앞 2자리" }),
    /* @__PURE__ */ jsx$1(InputWrapper, { children: /* @__PURE__ */ jsx$1(
      Input,
      {
        hasError,
        type: "password",
...
const useCardNumber = ({ handleNextStep }) => {
  ...
  const onChangeCardNumber = (e, n) => {
    const { value } = e.target;
    const isNumeric = value === "" || /^[0-9]+$/.test(value);
    if (!isNumeric) {
      return;
    }
    if (value.length > PARSE_RULE$3.length) {
      return;
    }
    const checkValidCardNumber = (value2) => {
      return value2.length < PARSE_RULE$3.length || Number(value2) < CARD_NUMBER_RULE.min;
    };
    setErrorMessage((prev2) => {
      const newError = [...prev2];
      const isNotValid = checkValidCardNumber(value);
      newError[n] = isNotValid ? ERROR_MESSAGE$3.CARD_NUMBER_LENGTH : "";
      return newError;
    });
    setCardNumber((prev2) => {
    ...
    const isCurrentCardNumberValid = value.length === PARSE_RULE$3.length && checkValidCardNumber(value) === false;
    ...
    const areAllPreviousCardNumberValid = cardNumber.slice(0, n).every((value2) => value2 !== "") && !getErrorMessageFromList(errorMessage.slice(0, n));
  ...
  return {
    ...
    errorMessage,
    setInputRef,
    isCardNumberValid: cardNumber.every((value) => value !== "") && !getErrorMessageFromList(errorMessage)
  };
};
const PARSE_RULE$2 = {
  length: 2
...
const validateCardValidityPeriod = ({
  ...
  if (!isValidMonthLength) {
    newErrorMessage.month = ERROR_MESSAGE$2.MONTH_LENGTH;
  } else {
    if (!checkMonthRange(monthNumber)) {
      newErrorMessage.month = ERROR_MESSAGE$2.MONTH_RANGE;
    }
  }
  if (!isValidYearLength) {
    newErrorMessage.year = ERROR_MESSAGE$2.YEAR_LENGTH;
  } else {
    ...
    if (yearRangeType === YEAR_RANGE_TYPE_RULE.greater) {
      ...
      newErrorMessage.year = ERROR_MESSAGE$2.YEAR_RANGE;
    } else if (yearRangeType === YEAR_RANGE_TYPE_RULE.same && !checkMonthRangeInSameYear(monthNumber)) {
      newErrorMessage.month = ERROR_MESSAGE$2.SAME_YEAR_MONTH_RANGE;
    }
  }
...
const useCardValidityPeriod = ({
  ...
  const onChangeMonth = (e) => {
    ...
    const isCardValidityPeriodValid = Object.values(newCardValidityPeriod).every((value2) => value2 !== "") && !getErrorMessageFromList(Object.values(newErrorMessage));
  ...
  return {
    ...
    errorMessage,
    setInputRef,
    isCardValidityPeriodValid: Object.values(cardValidityPeriod).every((value) => value !== "") && !getErrorMessageFromList(Object.values(errorMessage))
  };
};
const PARSE_RULE$1 = {
  length: 3
...
const useCardCVC = ({ handleNextStep }) => {
  ...
  const onChangeCVC = (e) => {
    ...
    const isNotValid = value.length < PARSE_RULE$1.length || value.length > PARSE_RULE$1.length || Number(value) < CVC_RULE.min;
    const newErrorMessage = isNotValid ? ERROR_MESSAGE$1.CARD_CVC_LENGTH : "";
    setErrorMessage(newErrorMessage);
    setCardCVC(value);
...
const useCardCompany = ({ handleNextStep }) => {
  const [selectedCard, setSelectedCard] = reactExports.useState(
    null
  );
  const onClickCardCompany = (name) => {
  ...
  return {
    selectedCard,
    CARD_COMPANY_NAMES,
    CARD_COMPANY_COLORS: selectedCard === null ? CARD_COMPANY_COLORS["기본"] : CARD_COMPANY_COLORS[selectedCard],
...
const useCardPassword = () => {
  ...
  const onChangeCardPassword = (e) => {
    ...
    const isNotValid = value.length < PARSE_RULE.length || value.length > PARSE_RULE.length || Number(value) < CARD_PASSWORD_RULE.min;
...
const useCardForm = () => {
  ...
  const canSubmit = isCardNumberValid && isCardCompanyValid && isCardValidityPeriodValid && isCardCVCValid && isCardPasswordValid;
  return {
    formData: {
      cardNumber,
      cardValidityPeriod,
    ...
    cardCompany: {
      NAMES: CARD_COMPANY_NAMES2,
      COLORS: CARD_COMPANY_COLORS2,
      PLACEHOLDER: CARD_COMPANY_PLACEHOLDER2
    },
    validation: {
...
function AddCard() {
  ...
  const {
    ...
    cardCVCErrorMessage,
    cardPasswordErrorMessage,
    getErrorMessageFromList: getErrorMessageFromList2
  } = validation;
        ...
        children: [
          /* @__PURE__ */ jsx$1(
            CardInputSection,
            {
              ...
              errorMessage: getErrorMessageFromList2(cardNumberErrorMessage),
              name: STEP_NAME.CardNumber,
              children: /* @__PURE__ */ jsx$1(
                CardNumberField,
                {
                  cardNumber,
                  errorStateList: cardNumberErrorMessage.map(
          ...
          /* @__PURE__ */ jsx$1(
            CardInputSection,
            {
              ...
              errorMessage: getErrorMessageFromList2(
...
function AddCardSuccess() {
  ...
  reactExports.useEffect(() => {
    if (!location.state || location.state.selectedCard === null || location.state.firstCardNumber.length !== PARSE_RULE$3.length) {
  ...
  return /* @__PURE__ */ jsx$1(Layout$1, { children: /* @__PURE__ */ jsxs(Wrapper, { children: [
    /* @__PURE__ */ jsx$1("img", { src: check, alt: "카드 등록 완료" }),
...
function App() {
  return /* @__PURE__ */ jsxs(Routes, { children: [
    /* @__PURE__ */ jsx$1(Route, { path: PAGE_URL.ADD_CARD, element: /* @__PURE__ */ jsx$1(AddCard, {}) }),
    /* @__PURE__ */ jsx$1(Route, { path: PAGE_URL.ADD_CARD_SUCCESS, element: /* @__PURE__ */ jsx$1(AddCardSuccess, {}) }),
    /* @__PURE__ */ jsx$1(Route, { path: PAGE_URL.NOT_FOUND, element: /* @__PURE__ */ jsx$1(Notfound, {}) })
  ] });
}
ReactDOM.createRoot(document.getElementById("root")).render(
  /* @__PURE__ */ jsx$1(React.StrictMode, { children: /* @__PURE__ */ jsx$1(BrowserRouter, { basename: "/react-payments", children: /* @__PURE__ */ jsx$1(App, {}) }) })
);
